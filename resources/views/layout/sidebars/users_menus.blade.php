...
<div class="tab-pane fade  @if( request()->segment(1) == 'admins' || request()->segment(1) == 'users' || request()->segment(1) == 'hosts' || request()->segment(1) == 'employees' ) active show @endif" id="kt_aside_nav_tab_menu_users"
     role="tabpanel">
    <div
