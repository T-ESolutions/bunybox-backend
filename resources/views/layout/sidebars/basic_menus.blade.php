...
@if(request()->segment(1) == 'operations') active show @endif
        ...
        <div id="kt_aside_menu_wrapper" class="menu-fit">
            ...
            <div class="menu-item">
                <div class="menu-content pt-8 pb-2">
                    <span class="menu-section text-muted text-uppercase fs-8 ls-1">{{trans('lang.operations')}}</span>
                </div>
            </div>

            <div class="menu-item">
                <a class="menu-link  @if(request()->routeIs('operations.*')) active @endif "
                   href="{{url('/operations')}}">
                   <span class="menu-icon">
                    ...
                    <span class="menu-title">{{__('lang.operations')}}</span>
            ...
            <div class="menu-item">
                <a class="menu-link  @if(request()->routeIs('zones.*')) active @endif "
                   ...
                   <span class="menu-icon">
                    ...
                    <span class="menu-title">{{__('lang.zones')}}</span>
