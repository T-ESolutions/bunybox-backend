...
@section('content')
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <!--begin::Form-->
        <form action="{{route("$route.update",['id'=>$row->id])}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="d-flex flex-column gap-7 gap-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="mb-5 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">{{__('lang.key')}}</label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="key" readonly
                                            ...
                                            <div class="mb-5 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">{{__('lang.value')}} </label>
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" required name="value"
                                                       class="form-control mb-2" value="{{$row->value}}"
                                                />
                                            </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{route('settings.index')}}" id="kt_ecommerce_add_product_cancel"
