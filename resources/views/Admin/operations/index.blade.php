...
@php
    $route = 'operations';
@endphp
@section('title',__('lang.operations'))
@section('header')
    <!--begin::Heading-->
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table align-middle table-row-dashed fs-4 gy-5" id="admins_table">
                        ...
                        <tr class="text-start text-muted fw-bolder fs-5 text-uppercase gs-0">
                            ...
                            <th class="min-w-125px">{{__('lang.order_num')}}</th>
                            <th class="min-w-125px">{{__('lang.empty_weight')}}</th>
                            <th class="min-w-125px">{{__('lang.full_weight')}}</th>
                            <th class="min-w-125px">{{__('lang.net_weight')}}</th>
                            <th class="min-w-125px">{{__('lang.client_name')}}</th>
                            <th class="min-w-125px">{{__('lang.item')}}</th>
        ...
        $(function () {
            var table = $('#admins_table').DataTable({
...

                    {
                        ...
                        customize: function (win) {
                            $(win.document.body)
                                ...
                                '                        <tbody> ' +
                                '                                <tr>' +
                                '                                    <td style="text-align: center">  <p style="padding-right:150px">شركة الراشد</p></td>' +
                ...
                columns: [
                    ...
                    {data: 'empty_weight', name: 'empty_weight', "searchable": true, "orderable": true},
                    {data: 'full_weight', name: 'full_weight', "searchable": true, "orderable": true},
                    {data: 'net_weight', name: 'net_weight', "searchable": true, "orderable": true},
                    {data: 'client_name', name: 'client_name', "searchable": true, "orderable": true},
                    {data: 'item', name: 'item', "searchable": true, "orderable": true},
